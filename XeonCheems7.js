...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "6283103795763") {
			let evaled,
				text = q,
...
//antilink youtube video by Lanxz
...
//antilink youtube channel by Lanxz
...
break
case 'alive': case 'list': case 'menu': case 'help': case '?': {
...
"sourceUrl": `${wagc}`
        ...
        await XeonBotInc.sendMessage(m.chat,{audio:menump3,
...
break
case 'gptmenu': {
var unicorn = await getBuffer(picak+'Gpt Menu')
sendXeonBotIncMessage(from, { 
text: `Hi @${sender.split("@")[0]}\n\n${ownermenu(prefix)}`,
mentions:[sender],
contextInfo:{
...
break
case 'reminimenu': {
var unicorn = await getBuffer(picak+'Remini Menu')
sendXeonBotIncMessage(from, { 
text: `Hi @${sender.split("@")[0]}\n\n${ownermenu(prefix)}`,
mentions:[sender],
contextInfo:{
...
break
case 'sc': case 'script': case 'donasi': case 'donate': case 'cekupdate': case 'updatebot': case 'cekbot': case 'sourcecode': {
me = m.sender
teks = `*「  ${global.botname} Script 」*\n\nYouTube: ${global.websitex}\nGitHub: ${global.botscript}\n\nHi @${me.split('@')[0]} 👋\nDont forget to donate yeah🍜 👇 https://i.ibb.co/16fxpKJ/IMG-20231203-WA0120-2.jpg`
sendXeonBotIncMessage(from, { 
text: teks,
mentions:[sender],
contextInfo:{
...
case 'chatgpt': case 'gpt': {
              ...
              try {
                ...
                if (response1.status === 200 && responseData1 && responseData1.status === true && responseData1.data) {
                  ...
                  const me = m.sender;
                  await XeonBotInc.sendMessage(m.chat, { text: message, mentions: [me] }, { quoted: m });
                } else {
...
case 'checkme':
					...
					var hoby = ['Cooking','Dancing','Playing','Gaming','Painting','Helping Others','Watching anime','Reading','Riding Bike','Singing','Chatting','Sharing Memes','Drawing','Eating Parents Money','Staying Alone']
...
XeonBotInc.sendMessage(m.chat, { image: proses, caption: mess.selesai}, { quoted: m})
}
break
case 'sticker': 
case 's': {
